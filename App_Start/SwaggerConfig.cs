...
namespace webapitemplate
{
    public class SwaggerConfig
    {
        ...
        {
            return apiDesc.ActionDescriptor.ControllerDescriptor.ControllerType.FullName != null && apiDesc.ActionDescriptor.ControllerDescriptor.ControllerType.FullName.Contains($"{targetApiVersion}.");
        }
    }
}
